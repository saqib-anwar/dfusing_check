...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num, add_noise, root, noise_trans, refine):
        ...
        #print('\n\nhere printing self.list_rank to check if list is setup alrigth: \n', (self.list_rank), '\n\n',len(self.list_rank))
    ...
    def __getitem__(self, index):
        ...
        print('length of choose here: ', len(choose))
        if len(choose) == 0:
        ...
        print('self.cam_fx value: ', cam_props(camera)[2])
        print('self.cam_fy value: ', cam_props(camera)[3])
        ...
        print('\n\n\nLONGTENSOR: ',ids,'\n\n\n')
        print('\n\n\nLONGTENSOR:',torch.LongTensor([ids]),'\n\n\n')
        
# order of returned data: whole_cloud, chosen_points_indices, img_masked, target_matrix, selected_pointcloud, id_tensor
